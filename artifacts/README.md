...
## Video Analysis Experiments for Semantic SLAM

We provide an experimental framework for using FastVLM on video data, with applications to semantic SLAM and season-invariant landmark detection. This includes:

- **Frame-by-frame semantic extraction** with keyframe selection
- **Temporal landmark tracking** across video sequences
- **Cross-temporal matching** for multi-session mapping
- **Scene graph construction** for semantic understanding
...
- **[VIDEO_ANALYSIS_INDEX.md](VIDEO_ANALYSIS_INDEX.md)** - Complete guide and index
- **[QUICK_START.md](QUICK_START.md)** - 5-minute quick start guide
- **[PROJECT_SUMMARY.md](PROJECT_SUMMARY.md)** - Overview and feasibility assessment

These tools are designed as stepping stones toward semantic SLAM systems that can match landmarks across seasonal changes and varying viewing conditions.
